package com.project.zhang.paper.annotation.validate;
...
public class ValidateAspectAop {
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.project.zhang.paper.annotation.validate.ValidateGroup)")
    public Object validateAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (Boolean.valueOf(flagMap.get(FLAG).toString())) {
            ...
            return new Back<>().error(flagMap.get("msg").toString());
        }
    }
